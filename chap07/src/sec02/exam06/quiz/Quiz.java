...
//	일하는 중입니다.
	...
	public static void main(String[] args) {
		// Quiz
		SchoolMember[] schoolM = new SchoolMember[3];
		schoolM[0] = new Staff();
		schoolM[1] = new Student();
		schoolM[2] = new Teacher();
		
		for (SchoolMember repeatObj : schoolM) {
			repeatObj.introduce();
			if (repeatObj instanceof Staff staff) {
				staff.work();
			}else if (repeatObj instanceof Student student) {
				student.study();
			}else if (repeatObj instanceof Teacher teacher) {
				teacher.teach();
			}
		}
