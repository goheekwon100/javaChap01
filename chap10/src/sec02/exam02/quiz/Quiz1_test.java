...
//	마지막까지 잘 도착했어요!!
	...
	public static void main(String[] args) {
		...
		System.out.println("합: " + Calculator.add(inputNum1, inputNum2));
		System.out.println("곱: " + Calculator.multiple(inputNum1, inputNum2));
		try {
			System.out.println("나누기: " + Calculator.divide(inputNum1, inputNum2));
